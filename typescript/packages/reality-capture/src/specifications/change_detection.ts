...
export const ChangeDetectionInputsSchema = z.object({
  ...
  preset: z
    .string()
    .describe("Path in the bucket of a preset file to use")
    .regex(/^bkt:.+/, {
...
export const ChangeDetectionOutputsSchema = z.object({
  segmentation3DA: z
    .string()
    .optional()
    .describe("ContextScene CD on Model3D A"),
  segmentedModel3DA: z
    .string()
    .optional()
    .describe("Model3D A with CD segmentation"),
  segmentation3DB: z
    .string()
    .optional()
    .describe("ContextScene CD on Model3D B"),
  segmentedModel3DB: z
    .string()
    .optional()
    .describe("Model3D B with CD segmentation"),
  locations3DA: z
    .string()
    .optional()
    .describe("Reality data id of locations of changes A"),
  locations3DAAsSHP: z
    .string()
    .optional()
    .describe("Reality data id of locations of changes A as SHP format"),
  locations3DAAsGeoJSON: z
    .string()
    .optional()
    .describe("Reality data id of locations of changes A as GeoJSON file"),
  locations3DB: z
    .string()
    .optional()
    .describe("Reality data id of locations of changes B"),
  locations3DBAsSHP: z
    .string()
    .optional()
    .describe("Reality data id of locations of changes B as SHP format"),
  locations3DBAsGeoJSON: z
    .string()
    .optional()
    .describe("Reality data id of locations of changes B as GeoJSON file"),
});
export type ChangeDetectionOutputs = z.infer<
  typeof ChangeDetectionOutputsSchema
>;

export const ChangeDetectionOptionsSchema = z.object({
  minPointsPerChange: z
    .number()
    .int()
    .optional()
    .describe(
  ...
  samplingResolution: z
    .number()
    .optional()
    .describe("Target point cloud resolution when starting from meshes"),
  growThreshold: z
    .number()
    .optional()
    .describe("Low threshold to detect spatial changes (hysteresis detection)"),
  filterThreshold: z
    .number()
    .optional()
    .describe(
...
export type ChangeDetectionOptions = z.infer<
  typeof ChangeDetectionOptionsSchema
>;

export const ChangeDetectionSpecificationsCreateSchema = z.object({
  inputs: ChangeDetectionInputsSchema.describe("Inputs"),
  outputs: z
    .array(z.nativeEnum(ChangeDetectionOutputsCreate))
    .describe("Outputs"),
  options: ChangeDetectionOptionsSchema.optional().describe("Options"),
});
export type ChangeDetectionSpecificationsCreate = z.infer<
  typeof ChangeDetectionSpecificationsCreateSchema
>;
...
export type ChangeDetectionSpecifications = z.infer<
  typeof ChangeDetectionSpecificationsSchema
>;
