...
export const Segmentation3DInputsSchema = z.object({
  ...
  pointCloudSegmentationDetector: z
    .string()
    .optional()
    .describe(
      "Either reality data id of point cloud segmentation object detector or point cloud segmentation detector identifier from the AI Detectors library",
    ),
  segmentation3D: z
    .string()
    .optional()
    .describe(
      "Reality data id of ContextScene, pointing to a segmented point cloud, this input replaces point_cloud_segmentation_detector, point_clouds and meshes inputs",
    ),
  extent: z
    .string()
    .regex(/^bkt:.+/)
...
export const Segmentation3DOutputsSchema = z.object({
  ...
  segmentedModel3D: z
    .string()
    .optional()
    .describe("Reality data id of the 3D segmentation as OPC file"),
  objects3D: z
    .string()
    .optional()
    .describe(
...
export const Segmentation3DOptionsSchema = z.object({
  saveConfidence: z
    .boolean()
    .optional()
    .describe("Save confidence in 3D segmentation"),
  computeLineWidth: z
    .boolean()
    .optional()
...
export const Segmentation3DSpecificationsCreateSchema = z.object({
  ...
  outputs: z
    .array(z.nativeEnum(Segmentation3DOutputsCreate))
    .describe("Outputs"),
  options: Segmentation3DOptionsSchema.optional().describe("Options"),
});
export type Segmentation3DSpecificationsCreate = z.infer<
  typeof Segmentation3DSpecificationsCreateSchema
>;
...
export type Segmentation3DSpecifications = z.infer<
  typeof Segmentation3DSpecificationsSchema
>;
