...
class TestJob:
    def test_appropriate_service_job(self):
        ...
        volume_specs = {"inputs": {"model3d": "pointCloud", "footprint": "bkt:roi"}, "outputs": {"volume": "bkt:volume"}}
    ...
    def test_appropriate_service_job_create(self):
        ...
        assert j.get_appropriate_service() == Service.ANALYSIS
        volume_specs = {"inputs": {"model3d": "pointCloud", "footprint": "bkt:roi"}, "outputs": ["volume"]}
