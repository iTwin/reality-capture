...
class Segmentation2DInputs(BaseModel):
    ...
    photo_segmentation_detector: Optional[str] = Field(None, alias="photoSegmentationDetector",
                                                       description="Either reality data ID (cloud) or local path (on-premise) of "
    ...
    segmentation2d: Optional[str] = Field(None, alias="segmentation2D",
                                          description="Reality data ID (cloud) or local path (on-premise) of ContextScene, pointing to segmented photos, "
...
class Segmentation2DOutputs(BaseModel):
    ...
    lines3d: Optional[str] = Field(None, alias="lines3D",
                                   description="Reality data ID (cloud) or local path (on-premise) of ContextScene, annotated with embedded 3D lines")
